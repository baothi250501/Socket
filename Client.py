...
import jsonfrom tkinter import *
from tkinter import ttk
from tkinter import messagebox
from tkinter import filedialog
from functools import partial
...
class ProcessGUI(object):
    ...
    def startProcGUI(self):
        ...
        self.IDStartEntry = Entry(self.master1,width = 40, textvariable=self.IDStartVar).pack(side = LEFT, padx = 5)
...
class AppGUI(object):
    ...
    def killAppGUI(self):
        ...
        self.master1.geometry("330x50")
        self.IDKillVar = StringVar()
        self.IDKillEntry = Entry(self.master1,width = 40, textvariable=self.IDKillVar).pack(side = LEFT, padx = 5)
...
class RegistryGUI(object):
    ...
    def __init__(self, master):
        ...
        LinkEntry1 = Entry(self.topFrame1,width = 40, textvariable= self.LinkVar1, state = "disabled").pack(side = LEFT, padx = 5)
        ...
        LinkEntry2 = Entry(self.topFrame3,width = 40, textvariable=self.LinkVar2).pack(side = TOP, fill = X, padx = 2)
...
from io import BytesIO
import osC:\Users\WIN10\Desktop\Client\Client.py
